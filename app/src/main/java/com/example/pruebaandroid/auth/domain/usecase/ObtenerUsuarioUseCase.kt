...
class ObtenerUsuarioUseCase @Inject constructor(private val usuarioRepository: UsuarioRepository) {
    suspend operator fun invoke(id: String?): Usuario? {
        return if (id != null) usuarioRepository.obtenerUsuario(id) else usuarioRepository.obtenerPrimerUsuario()
    }
}
